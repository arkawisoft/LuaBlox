...
OPENCLOSE.MouseButton1Click:Connect(function()
    game.CoreGui:FindFirstChild("PawanXUI").Enabled = not game.CoreGui:FindFirstChild("PawanXUI").Enabled
end)
do
...
function PawanX:CreateWindow(pawanxtitle)
    local PawanXUI = Instance.new("ScreenGui")
    local Window = Instance.new("Frame")
    local PawanXText1 = Instance.new("TextLabel")
    local PawanXText2 = Instance.new("TextLabel")
    ...
    PawanXUI.Name = "PawanXUI"
    PawanXUI.Parent = game.CoreGui
    PawanXUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    
    Window.Name = "Window"
    Window.Parent = PawanXUI
    Window.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Window.BorderSizePixel = 0
    Window.Position = UDim2.new(0, 392, 0, 264)
    Window.Size = UDim2.new(0, 390, 0, 350)
    
    PawanXText1.Name = "PawanXText1"
    PawanXText1.Parent = Window
    PawanXText1.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    PawanXText1.BackgroundTransparency = 1.000
    PawanXText1.BorderSizePixel = 0
    PawanXText1.Position = UDim2.new(0, 30, 0, 0)
    PawanXText1.Size = UDim2.new(0, 35, 0, 20)
    PawanXText1.Font = Enum.Font.GothamSemibold
    PawanXText1.Text = "NhanTestHub      |"
    PawanXText1.TextColor3 = Color3.fromRGB(250, 250, 250)
    PawanXText1.TextSize = 13.000
    
    PawanXText2.Name = "DinoHubText2"
    PawanXText2.Parent = Window
    PawanXText2.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    PawanXText2.BackgroundTransparency = 1.000
    PawanXText2.BorderSizePixel = 0
    PawanXText2.Position = UDim2.new(0, 40, 0, 0)
    PawanXText2.Size = UDim2.new(0, 35, 0, 20)
    PawanXText2.Font = Enum.Font.GothamSemibold
    PawanXText2.Text = ""
    PawanXText2.TextColor3 = Color3.fromRGB(250, 250, 250)
    PawanXText2.TextSize = 13.000
    ...
    ContainerHolder.BackgroundColor3 = Color3.fromRGB(78, 110, 99)
    ...
    function PawanXWindow:NewPage(pagetitle)
        ...
        function PawanXPage:NewSection(sectiontitle)
            ...
            function PawanXElement:CreateButton(buttontitle, buttoncallback)
            ...
            function PawanXElement:CreateToggle(toggletitle, togglecallback)
            ...
            function PawanXElement:CreateSlider(slidertitle, minvalue, maxvalue, callback)
            ...
            function PawanXElement:CreateTextBox(textboxtitle, textboxplaceholdertitle,textboxcallback)
            ...
            function PawanXElement:CreateDropdown(dropdowntitle, list, dropdowncallback)
                list = list or {}
                ...
                local PawanXDropdown = {}

                function PawanXDropdown:RefreshDropdown(newlist)
                    newlist = newlist or {}
                ...
                return PawanXDropdown
            end

            function PawanXElement:CreateLabel(labeltitle)
                local DropdownHolderTitle = Instance.new("TextLabel")
                ...
                function PawanXLabel:ChangeLabel(newlabeltitle)
...
local PawanXWindow = PawanX:CreateWindow("Note: This is the version test | Waiting for update")
local PawanXPage = PawanXWindow:NewPage("Main")
local PawanXPage1 = PawanXWindow:NewPage("Auto Stats Points")
local PawanXPage2 = PawanXWindow:NewPage("Buy Melee")
local Home = PawanXPage:NewSection(" Farm ")
local stat = PawanXPage1:NewSection("Auto Stats")
local Buy = PawanXPage2:NewSection("Get Melee")
