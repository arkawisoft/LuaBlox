if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    _G.Color = Color3.fromRGB(0, 255, 247)
    ...
    function library:AddWindow(text, keybind)
        ...
        NameHub.Text = text
        NameHub.TextColor3 = Color3.fromRGB(0, 255, 247)
        ...
        function uitab:AddTab(text, image)
            ...
            function main:AddToggle(text, config, callback)
                ...
                ToggleImage2.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
            ...
            function main:AddSlider(text, min, max, set, callback)
                ...
                Bar.Name = "Bar"
                Bar.Parent = Bar1
                Bar.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
            ...
            function main:AddSeperator(text)
                ...
                Sep1.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
                ...
                Sep2.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
            ...
            function main:AddLine()
                ...
                Linee.Name = "Linee"
                Linee.Parent = Line
                Linee.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
    ...
    function CheckQuest()
        ...
        elseif World3 then
            ...
            elseif MyLevel == 2125 or MyLevel <= 2149 then
                ...
                CFrameQuest =
                    CFrame.new(-820.64825439453, 65.819526672363, -10965.795898438, 0, 0, -1, 0, 1, 0, 1, 0, 0)
            ...
            elseif MyLevel == 2200 or MyLevel <= 2224 then
                ...
                CFrameQuest = CFrame.new(-2021.32007, 37.7982254, -12028.7295, 0.957576931, -8.80302053e-08,
                    0.288177818, 6.9301187e-08, 1, 7.51931211e-08, -0.288177818, -5.2032135e-08, 0.957576931)
                ...
                if not isnil(v.Character) then
                    if not v.Character.Head:FindFirstChild('NameEsp' .. v.Name) then
                        ...
                        if v.Team == game:GetService("Players").LocalPlayer.Team then
                            ...
                            ESP.TextColor3 = Color3.new(0, 255, 247)
                        end
                        ESP.TextSize = 14
                        ...
                        HealthESP.TextColor3 = Color3.fromRGB(0, 255, 247)
        ...
        pcall(function()
            while wait() do
                if _G.AutoAdvanceDungeon or _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.AutoFarmChest or
                    ...
                    _G.AutoElectricClaw or _G.AutoFarmGunMastery or _G.AutoHolyTorch or _G.AutoLawRaid or
                    ...
                    _G.AutoSharkman or _G.AutoGodHuman or _G.Auto_Mastery_Fruit or _G.Auto_Mastery_Gun or _G.Auto_Dungeon or
                    _G.Auto_Cavender or _G.Auto_Pole or _G.Auto_Kill_Ply or _G.Auto_Factory or _G.AutoSecondSea or
                    _G.TeleportPly or _G.AutoBartilo or _G.Auto_DarkBoss or _G.GrabChest or _G.AutoFarmBounty or
                    _G.Holy_Torch or _G.AutoFarm or _G.Clip or FarmBoss or _G.AutoElitehunter or _G.AutoThirdSea or
                    _G.Auto_Bone or _G.FastAttack == true then
        ...
        pcall(function()
            game:GetService("RunService").Stepped:Connect(function()
                if _G.AutoAdvanceDungeon or _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.AutoFarmChest or
                    ...
                    _G.AutoElectricClaw or _G.AutoFarmGunMastery or _G.AutoHolyTorch or _G.AutoLawRaid or
                    _G.AutoFarmBoss or _G.AutoTwinHooks or _G.AutoOpenSwanDoor or _G.AutoDragon_Trident or _G.AutoSaber or
                    _G.NOCLIP or _G.AutoFarmFruitMastery or _G.AutoFarmGunMastery or _G.TeleportIsland or
                    ...
                    _G.AutoDarkDagger or _G.Safe_Mode or _G.MasteryFruit or _G.AutoBudySword or _G.AutoBounty or
                    _G.AutoAllBoss or _G.Auto_Bounty or _G.AutoSharkman or _G.AutoGodHuman or _G.Auto_Mastery_Fruit or _G.Auto_Mastery_Gun or
                    ...
                    _G.AutoThirdSea or _G.Auto_Bone or _G.FastAttack == true then
    ...
    spawn(function()
        while wait() do
            if _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.AutoFarmChest or _G.AutoFarmBossHallow or
                ...
                _G.AutoObservationv2 or _G.AutoMusketeerHat or _G.AutoEctoplasm or _G.AutoRengoku or
                _G.Auto_Rainbow_Haki or _G.AutoObservation or _G.AutoDarkDagger or _G.Safe_Mode or _G.MasteryFruit or
                _G.AutoBudySword or _G.AutoAllBoss or _G.Auto_Bounty or _G.AutoSharkman or _G.AutoGodHuman or _G.Auto_Mastery_Fruit or
                ...
                _G.AutoFarm or _G.Clip or _G.AutoElitehunter or _G.AutoThirdSea or _G.Auto_Bone or _G.FastAttack == true then
                pcall(function()
    ...
    Toggle.Text = "P"
    Toggle.TextColor3 = Color3.fromRGB(0, 255, 247)
    ...
    --------------------------------------------------------------------
    local PawanXUi = library:AddWindow("PawanX-Hub", Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
    local Main = PawanXUi:AddTab("Auto Farm", "6026568198")
    local Combat = PawanXUi:AddTab("Combat", "7251993295")
    local Stats = PawanXUi:AddTab("Stats", "7040410130")
    local Teleport = PawanXUi:AddTab("Teleport", "6035190846")
    local Dungeon = PawanXUi:AddTab("Dungeon", "7044284832")
    local DevilFruit = PawanXUi:AddTab("Devil Fruit", "7044233235")
    local Shop = PawanXUi:AddTab("Shop", "6031265976")
    local Misc = PawanXUi:AddTab("Misc", "6034509993")
    --------------------------------------------------------------------
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild(Mon) then
                                    ...
                                    if v.Name == Mon then
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest
                                            ...
                                            repeat
                                                ...
                                                topos(v.HumanoidRootPart.CFrame * CFrame.new(5, 20, 7))
                            ...
                            if game:GetService("ReplicatedStorage"):FindFirstChild(Mon) then
                                ...
                                if (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <=
                                    15 then
                                    if PosMon ~= nil then
                                        topos(PosMon * CFrame.new(5, 20, 7))
                                    else
                                        if OldPos ~= nil then
    ...
    Main:AddToggle("Auto God Human", _G.AutoGodHuman, function(value)
        ...
        pcall(function()
            game:GetService("RunService").RenderStepped:Connect(function()
                if UseSkill then
                    ...
                    game:GetService("Players").LocalPlayer.Character[game:GetService("Players").LocalPlayer.Data
                        .DevilFruit.Value].RemoteEvent:FireServer(unpack(args))
                end
            end)
        end)
    end)
    ...
    spawn(function()
        pcall(function()
            while wait(.1) do
                if (_G.AutoFarmSwanGlasses and _G.AutoFarmSwanGlasses_Hop) and World2 and
