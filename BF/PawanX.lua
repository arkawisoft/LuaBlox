if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
        ...
        pcall(function()
            while wait() do
                if _G.AutoAdvanceDungeon or _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.Auto_Farm_LevelChest or
                    _G.Auto_Farm_BossHallow or _G.Auto_Farm_LevelSwanGlasses or _G.AutoLongSword or _G.AutoBlackSpikeycoat or
                    _G.AutoElectricClaw or _G.Auto_Farm_LevelGunMastery or _G.AutoHolyTorch or _G.AutoLawRaid or
                    _G.Auto_Farm_Boss or _G.AutoTwinHooks or _G.AutoOpenSwanDoor or _G.AutoDragon_Trident or _G.AutoSaber or
        ...
        pcall(function()
            game:GetService("RunService").Stepped:Connect(function()
                if _G.AutoAdvanceDungeon or _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.Auto_Farm_LevelChest or
                    ...
                    _G.AutoElectricClaw or _G.Auto_Farm_LevelGunMastery or _G.AutoHolyTorch or _G.AutoLawRaid or
                    _G.Auto_Farm_Boss or _G.AutoTwinHooks or _G.AutoOpenSwanDoor or _G.AutoDragon_Trident or _G.AutoSaber or
                    _G.NOCLIP or _G.Auto_Farm_LevelFruitMastery or _G.Auto_Farm_LevelGunMastery or _G.TeleportIsland or
                    _G.Auto_EvoRace or _G.Auto_Farm_LevelAllMsBypassType or _G.AutoObservationv2 or _G.AutoMusketeerHat or
                    ...
                    _G.Auto_Farm_LevelBounty or _G.Holy_Torch or _G.Auto_Farm_Level or _G.Clip or _G.AutoElitehunter or
    ...
    spawn(function()
        while wait() do
            if _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.Auto_Farm_LevelChest or _G.Auto_Farm_BossHallow or
                ...
                _G.Auto_Farm_LevelGunMastery or _G.AutoHolyTorch or _G.AutoLawRaid or _G.Auto_Farm_Boss or _G.AutoTwinHooks or
                _G.AutoOpenSwanDoor or _G.AutoDragon_Trident or _G.AutoSaber or _G.NOCLIP or _G.Auto_Farm_LevelFruitMastery or
                _G.Auto_Farm_LevelGunMastery or _G.TeleportIsland or _G.Auto_EvoRace or _G.Auto_Farm_LevelAllMsBypassType or
                ...
                _G.Auto_Farm_Level or _G.Clip or _G.AutoElitehunter or _G.AutoThirdSea or _G.Auto_Bone == true then
                pcall(function()
                                    ...
                                    if v.Name == Mon then
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest
                                            ...
                                            repeat
                                                ...
                                                game:GetService 'VirtualUser':CaptureController()
                                                game:GetService 'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                            until not _G.Auto_Farm_LevelFruitMastery or v.Humanoid.Health <= 0 or not v.Parent or
    ...
    local EventServ = Event:AddLabel("Events")

    Event:AddSeperator("Xmas")

    Event:AddToggle("Auto Xmas", _G.AutoXmas, function(value)
        _G.AutoXmas = value
        StopNoClip(_G.AutoXmas)
    end)

    Event:AddToggle("Auto Xmas Hop", _G.AutoXmas_Hop, function(value)
    ...
    Event:AddSeperator("Santa Events")

    Event:AddToggle("Auto Santa Events", _G.AutoSantaEvents, function(value)
        _G.AutoSantaEvents = value
        StopNoClip(_G.AutoSantaEvents)
    end)

    Event:AddToggle("Auto Santa Events Hop", _G.AutoSantaEvents_Hop, function(value)
    ...
    spawn(function()
        game:GetService("RunService").RenderStepped:Connect(function()
            if _G.AutoGhostShip or _G.AutoSantaEvents or _G.AutoSecondSea or _G.AutoXmas or _G.AutoSeaking or
                _G.AutoBigMomBlade or _G.AutoBigMomBoss or _G.AutoKaido or _G.AutoSaber or _G.AutoKillply or _G.Auto_Farm_Level or
                _G.AutoBisento or _G.Auto_Farm_LevelDungeon or _G.AutoKillply or _G.AutoEnma then
        ...
        pcall(function()
            game:GetService("RunService").Stepped:Connect(function()
                if _G.AutoSantaEvents or _G.AutoSecondSea or _G.AutoXmas or _G.AutoSeaking or _G.AutoBigMomBlade or
                    _G.AutoBigMomBoss or _G.AutoKaido or _G.AutoSaber or _G.AutoKillply or _G.Auto_Farm_Level or _G.AutoBisento or
                    _G.Auto_Farm_LevelDungeon or _G.AutoKillply or _G.AutoEnma or _G.NoClip then
                            ...
                            for i, v in pairs(game:GetService("Workspace").MOB:GetChildren()) do
                                if v:FindFirstChild("HumanoidRootPart") then
                                    repeat
                                        ...
                                        UseSkill("C")
                                        UseSkill("V")
                                    until v.Humanoid.Health <= 0 or not _G.Auto_Farm_LevelDungeon or not AutoFarmMobDungeon or
    ...
    spawn(function()
        game:GetService("RunService").RenderStepped:Connect(function()
            if _G.NoClip or _G.Auto_Farm_Level or _G.Auto_Farm_LevelFactory or _G.AutoSeaBeats or _G.AutoTreeMonster or
                _G.AutoFlameEmperor or _G.AutoGodOfLighting or _G.Auto_Farm_LevelPlayer or _G.AutoSwordMan or _G.AutoShisui then
                if not game:GetService("Workspace"):FindFirstChild("TaiFoot") then
                    local Part = Instance.new("Part")
                    Part.Name = "TaiFoot"
                    Part.Parent = game.Workspace
